 ...
 */
public class SingleChoosableTreeItemAdapterExampleActivityTest {
    @Rule
    public ActivityTestRule<SingleChoosableTreeItemAdapterExampleActivity> mActivityTestRule = new ActivityTestRule<>(SingleChoosableTreeItemAdapterExampleActivity.class, false, true);
