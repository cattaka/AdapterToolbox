 ...
 */
public class SimpleStringViewHolderFactory implements ScrambleAdapter.IViewHolderFactory<ScrambleAdapter, RecyclerView.ViewHolder, ForwardingListener<ScrambleAdapter, RecyclerView.ViewHolder>, SimpleStringViewHolderFactory.ViewHolder, ForwardingListener<ScrambleAdapter, RecyclerView.ViewHolder>> {
    @Override
