 ...
 */
public class SingleChoosableTreeItemAdapterExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        { // set adapter
            ...
            adapter.setChoiceMode(AbsChoosableTreeItemAdapter.CHOICE_MODE_SINGLE);
